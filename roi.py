        ...
        for ligne in board:
            ...
            for case in ligne:
                ...
                if case == i:
                    ...
                    if i == 'R':
                        if tour.move_piece(board, player_turn, nb_colonne, nb_ligne, i_origine, j_origine):
                            print('la tour menace')
                            return False
                    
                    if i == 'N':
                        if cavalier.move_piece(board, player_turn, nb_colonne, nb_ligne, i_origine, j_origine):
                            print('le cavaliver menace')
                            return False
                        
                    if i == 'B':
                        if fou.move_piece(board, player_turn, nb_colonne, nb_ligne, i_origine, j_origine):
                            print('la tour menace')
                            return False
                    ...
                    if i == 'K':
                        if mouvement_possible(board, player_turn, nb_colonne, nb_ligne, i_origine, j_origine):
                            print('le roi menace')
                            return False
                    
                    if i == 'P':
                        if pion.move_piece(board, player_turn, nb_colonne, nb_ligne, i_origine, j_origine):
                            print('le pion menace')
                            return False
